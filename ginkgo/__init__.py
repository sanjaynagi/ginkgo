...
_EXPORTS = {
    ...
    "NotebookExpr": ("ginkgo.core.notebook_expr", "NotebookExpr"),
    "PartialCall": ("ginkgo.core.task", "PartialCall"),
    "ScriptExpr": ("ginkgo.core.script_expr", "ScriptExpr"),
    ...
    "notebook": ("ginkgo.core.notebook_expr", "notebook"),
    "script": ("ginkgo.core.script_expr", "script"),
